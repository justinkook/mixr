...
const links = [
  ...
  { name: 'API Reference', href: '#', description: 'A complete API reference for our libraries.', icon: LayersIcon },
  {
    name: 'Guides',
    href: '#',
  ...
  return (
    <main className="mx-auto w-full max-w-7xl px-6 pb-16 pt-10 sm:pb-24 lg:px-8">
      ...
      <div className="mx-auto mt-20 max-w-2xl text-center sm:mt-24">
        ...
        <h1 className="mt-4 text-3xl font-bold tracking-tight text-foreground sm:text-5xl">This page does not exist</h1>
      ...
      <div className="mx-auto mt-16 flow-root max-w-lg sm:mt-20">
        ...
        <ul role="list" className="-mt-6 divide-y divide-muted border-b border-muted">
