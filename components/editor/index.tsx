...
import { EditorBubbleMenu } from '@/components/editor/bubble-menu/bubble-menu'
import { defaultExtensions } from '@/components/editor/extensions/default-extensions'
import { ImageResizer } from '@/components/editor/extensions/image-resizer'
...
export function Editor({
   ...
   * Defaults to "relative min-h-[500px] w-full max-w-screen-lg border-muted bg-background sm:mb-[calc(20vh)] sm:rounded-lg sm:border sm:shadow-lg".
   */
  className?: string
  /**
