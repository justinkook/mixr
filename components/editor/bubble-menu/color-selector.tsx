  ...
  return (
    <Popover.Root open={isOpen}>
      <div className="relative h-full">
        <Popover.Trigger
          className="flex h-full items-center gap-1 p-2 text-sm font-medium text-muted-foreground hover:bg-muted active:bg-muted"
        ...
        <Popover.Content
          align="start"
          className="z-[99999] my-1 flex max-h-80 w-48 flex-col overflow-hidden overflow-y-auto rounded border border-muted bg-background p-1 shadow-xl animate-in fade-in slide-in-from-top-1"
        >
          ...
          {HIGHLIGHT_COLORS.map(({ name, color }, index) => (
            ...
            >
              <div className="flex items-center space-x-2">
                <div
                  className="rounded-sm border border-muted px-1 py-px font-medium"
